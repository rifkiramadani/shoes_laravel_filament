            ...
            <section id="your-order" class="accordion flex flex-col rounded-[20px] p-4 pb-5 gap-5 mx-4 bg-white overflow-hidden transition-all duration-300 has-[:checked]:!h-[66px]">
                ...
                <div class="flex items-center gap-[14px]">
                    <div class="flex shrink-0 w-20 h-20 rounded-[20px] bg-[#D9D9D9] p-1 overflow-hidden">
                        <img src="{{asset('storage/' . $orderDetails->shoe->thumbnail)}}" class="w-full h-full object-contain" alt="">
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-bold">Rp {{number_format($orderDetails->sub_total_amount, 0, ',', '.')}}</p>
                </div>
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-bold">{{$orderDetails->created_at->format('d M Y')}}</p>
                </div>
                @if ($orderDetails->is_paid == true)
                    <div class="flex items-center justify-between">
